...
Prefer pending frontier ideas from continuation_summary.pending_followups. Use fresh_hypothesis only when pending followups are blocked, exhausted, or lower value.
...
When selecting a pending frontier idea, set selected_idea_ids. When selecting a fresh idea, leave selected_idea_ids empty and set fresh_selection_reason.
