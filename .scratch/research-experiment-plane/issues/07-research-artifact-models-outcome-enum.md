...
- [ ] Research Outcome enum contains only the PRD-approved values.
- [ ] Core artifacts validate selected plan, spec/design, critique, audit, evaluation, summary, and plan update payloads.
- [ ] Diagnostic fields support `outcome_reason`, `failed_stage`, and `failure_classification`.
- [ ] Tests cover valid artifacts, invalid artifacts, and enum serialization.
